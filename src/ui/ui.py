...
>>>>>>> 267c517 (Chat with Prometheus - Claude Desktop Intelligence)
...
# --- 🤖 Chat with Prometheus Page ---
    ...
    if user_question and claude_chatbot:
        ...
        with st.chat_message("assistant", avatar="🤖"):
            ...
            try:
                # Update status
                message_placeholder.markdown("⚡ **Querying Prometheus metrics...**")
                
                # Get response from Claude (PromQL queries always included)
